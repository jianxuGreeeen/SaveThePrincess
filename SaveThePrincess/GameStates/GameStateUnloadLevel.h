#ifndef GAME_STATE_UNLOAD_LEVEL_H
#define GAME_STATE_UNLOAD_LEVEL_H
#pragma once
...
/// UnLoads a level
/// </summary>
class GameStateUnloadLevel final : public GameStateInterface
{
public:
...
#endif // GAME_STATE_UNLOAD_LEVEL_H
